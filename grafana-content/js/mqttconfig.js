...
// MQTT Topics
var nanohomeTopicRoot = "nanohome";
var statusOutTopicRoot = "shellystatus";
var statusOutTopicSuffix = "status/rpc";

// Device manager
var connectedTopic = "+/status/+/connected";
var descriptionTopic = "+/status/+/description";
var dashboardTopic = nanohomeTopicRoot + "/config/dashboard";
...
// Timer & standby
var timerTopic = nanohomeTopicRoot + "/+/timer";
var standbyTopic = nanohomeTopicRoot + "/+/standby";

// Legacy Topics
var legacyTopicRoot = "shellies";
var outputTopicLegacy = legacyTopicRoot + "/+/relay/0";
var connectedTopicLegacy = legacyTopicRoot + "/+/+/+/connected";
var descriptionTopicLegacy = legacyTopicRoot + "/+/+/+/description";
